...
call s:GuiFor('cssTagName', 'NONE', s:orange)
call s:GuiFor('cssBraces', 'NONE', s:foreground)
call s:GuiFor('cssPseudoClassId', 'NONE', s:violet)
call s:GuiFor('cssProp', 'NONE', s:grey)
call s:GuiFor('cssMediaType', 'NONE', s:red)
call s:GuiFor('cssIncludeKeyword ', 'NONE', s:red)
call s:GuiFor('cssInclude', 'NONE', s:cyan)
call s:GuiFor('cssIdentifier ', 'NONE', s:cyan)
call s:GuiFor('cssAttrComma', 'NONE', s:cyan)
call s:GuiFor('cssImportant', 'NONE', s:orange)
call s:GuiFor('cssAttributeSelector', 'NONE', s:magenta)
call s:GuiFor('cssFontAttr', 'NONE', s:magenta)
call s:GuiFor('cssFontDescription', 'NONE', s:magenta)
call s:GuiFor('cssDefinition', 'NONE', s:magenta)
