...
theme.set_highlights = function()
    ...
    -- Telescope
    hl(0, "TelescopeSelection", { fg = 'NONE', bg = c.selection })
    hl(0, "TelescopeSelectionCaret", { fg = c.red, bg = c.selection })
    hl(0, "TelescopeMatching", { fg = c.yellow, bg = 'NONE', bold = true, italic = true, })
    hl(0, "TelescopeBorder", { fg = c.light_grey, bg = 'NONE' })
    hl(0, "TelescopeNormal", { fg = c.light_grey, bg = c.alt_bg })
    ...
    hl(0, "NvimTreeNormal", { fg = c.white, bg = c.alt_bg })
    hl(0, "NvimTreeVertSplit", { fg = c.alt_bg, bg = c.alt_bg })
    hl(0, "NvimTreeFolderName", { fg = c.white, bg = 'NONE', italic = true })
    ...
    hl(0, "NvimTreeGitIgnored", { fg = c.light_grey, bg = 'NONE', italic = true, })
