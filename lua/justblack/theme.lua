...
theme.set_highlights = function()
    ...
    hl(0, "cssProp", { fg = c.white, bg = 'NONE', italic = true })
    hl(0, "cssFontProp", { fg = c.white, bg = 'NONE', italic = true })
    hl(0, "cssPositioningProp", { fg = c.white, bg = 'NONE', italic = true })
    hl(0, "cssUIProp", { fg = c.white, bg = 'NONE', italic = true })
    hl(0, "cssTextProp", { fg = c.white, bg = 'NONE', italic = true })
    hl(0, "cssBorderProp", { fg = c.white, bg = 'NONE', italic = true })
    hl(0, "cssBoxProp", { fg = c.white, bg = 'NONE', italic = true })
    hl(0, "cssBackgroundProp", { fg = c.white, bg = 'NONE', italic = true })
